<?php
    ...
    $consulta = "SELECT * FROM cargos WHERE identificador = '$identificador'";
...
<div class="header">
    <nav>
        <ul class="menu">
            ...
            <li><i class='bx bx-shield-alt-2'></i><a class="lugar" href="../paneles/cargos.php">Cargos</a></li>
...
<div class="contenido_usuarios">
    ...
    <hr>
    <form class="formulario_insertar_usuarios" action="update_cargos.php" method="post">
