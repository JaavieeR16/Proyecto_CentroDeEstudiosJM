<?php
    ...
    $consulta = "SELECT * FROM registro WHERE identificador = '$identificador'";
...
<div class="header">
    <nav>
        <ul class="menu">
            ...
            <li><i class='bx bx-user'></i><a href="../paneles/usuarios.php">Usuarios</a></li>
            <li><i class='bx bxs-id-card'></i><a class="lugar" href="../paneles/registros.php">Registros</a></li>
...
<div class="contenido_usuarios">
    ...
    <hr>
    <form class="formulario_insertar_usuarios" action="update_registros.php" method="post">
